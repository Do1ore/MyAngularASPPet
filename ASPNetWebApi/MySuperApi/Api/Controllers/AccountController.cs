    ...
    public class AccountController : ControllerBase
    {
        ...
        public async Task<IActionResult> UploadAsync()
        {
            ...
            if (file.Length > 0)
            {
                ...
                await _chatRepository.UpdateCurrentProfileImage(profileImage.ImageId.ToString(), userId);
        ...
        public async Task<IActionResult> GetProfileImage()
        {
            ...
            string imagePath = await _chatRepository.GetProfileImage(userId);
        ...
        public async Task<FileContentResult> GetProfileImageById([FromBody] UserIdModel userIdModel)
        {
            ...
            string imagePath = await _chatRepository.GetProfileImage(userIdModel.userId);
            if (string.IsNullOrEmpty(imagePath))
            {
            }
